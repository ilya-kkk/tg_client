...
- [x] **Добавить пункт «Нейрокомментарии»** в навигационный sidebar `FrontEnd/app/(dashboard)/layout.tsx` (или аналогичный компонент навигации).
- [x] **Реализовать модальное окно создания/редактирования кампании** в интерфейсе как в разделе «Автореакции»:
