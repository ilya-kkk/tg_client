...
### 9. Работа с файлами
- [NO] Загрузка файлов на серверы Telegram — не реализовано как отдельный REST-эндпоинт: загрузка сейчас выполняется только в составе операций отправки медиа (`/messages/send-media` и др.).  
